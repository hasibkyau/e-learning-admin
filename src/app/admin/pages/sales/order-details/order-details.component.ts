...
import {DiscountType, Order} from "../../../../interfaces/common/procuct-order.interface";
      ...
      content: [
        {
          columns: [
            ...
            [
              {
                width: 'auto',
                text: `www.test.com.bd`,
                style: 'p',
              },
              {
                width: 'auto',
                text: `৬৮৬ পশ্চিম শেওড়া পাড়া , মিরপুর , ঢাকা - ১২১৬`,
                style: 'pBn',
              },
              {
                width: 'auto',
                text: `Telephone: +8801787000000`,
                style: 'p',
              },
              {
                width: 'auto',
                text: `Email: info@test.com.bd`,
                style: 'p',
              },
            ],
            [
                ...
                text: [
                  {
                    text:
                      ...
                      this.order.productDiscount > 0
                        ? `You Saved ${this.order.productDiscount} TK from test.com.bd`
                        : '',
                    bold: true,
                  },
                ],
        ...
        {
          text: 'Thank you for your order from www.test.com.bd',
          style: 'p',
          alignment: 'center',
          margin: [0, 10],
        },
  ...
  dataTableForPdfMake() {
    ...
    this.order.orderedItems.forEach((m, i) => {
      const res = [
        ...
        {
          text: `${m?.discountAmount ?? 0}${m.discountType ===1 ? '%' : m.discountType ===2 ? 'TK':''}`,
          style: 'tableBody',
          borderColor: ['#eee', '#eee', '#eee', '#eee'],
        },
        {
          text: m.regularPrice + 'TK',
          style: 'tableBody',
          borderColor: ['#eee', '#eee', '#eee', '#eee'],
        },
        {
          text: m.regularPrice * m.quantity + 'TK',
          style: 'tableBody',
          borderColor: ['#eee', '#eee', '#eee', '#eee'],
        },
      ];
