...
export class AllCategoryComponent implements OnInit {
    ...
    this.subForm = formValue
      .pipe(
        ...
        switchMap((data) => {
          ...
          return this.categoryService.getAllCourseCategories(
            filterData,
            this.searchQuery
          );
        })
  ...
  private deleteMultipleCategoryById() {
    ...
    this.subDataTwo = this.categoryService
      .deleteMultipleCourseCategoryById(this.selectedIds)
      .subscribe(
        (res) => {
          this.spinner.hide();
          if (res.success) {
  ...
  private updateMultipleCategoryById(data: any) {
    this.spinner.show();
    this.subDataThree = this.categoryService.updateMultipleCourseCategoryById(this.selectedIds, data)
      .subscribe(res => {
        this.spinner.hide();
        if (res.success) {
          this.selectedIds = [];
  ...
  exportToAllExcel() {
    ...
    this.subDataOne = this.categoryService
      .getAllCourseCategories(filterData, this.searchQuery)
      .subscribe({
        next: (res) => {
