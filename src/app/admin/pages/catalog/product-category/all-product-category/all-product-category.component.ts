...
@Component({
  ...
  styleUrls: ['./all-product-category.component.scss']
})
export class AllProductCategoryComponent implements OnInit {
  ...
  private deleteMultipleCategoryById() {
    ...
    this.subDataTwo = this.productCategoryService
      .deleteCategoryById(this.selectedIds)
      .subscribe(
        (res) => {
          this.spinner.hide();
          if (res.success) {
  ...
  private updateMultipleCategoryById(data: any) {
    this.spinner.show();
    this.subDataThree = this.productCategoryService.updateCategoryById(this.selectedIds, data)
      .subscribe(res => {
        this.spinner.hide();
        if (res.success) {
          this.selectedIds = [];
