...
import {CompanyBankInfo, CompanyInfo} from '../../interfaces/core/app-data.interface';
...
export const ADMIN_ROLES: Select[] = [
  ...
  {value: AdminRolesEnum.EDITOR, viewValue: 'Teacher'},
  // {value: AdminRolesEnum.ACCOUNTANT, viewValue: 'Accountant'},
];
...
export const COURSE_TYPES: Select[] = [
  {value: 'video-course', viewValue: 'Video Course'},
  {value: 'live-course', viewValue: 'Live Course'},
  {value: 'lecture-sheet', viewValue: 'PDF Course'},
];

// 'video-course' | 'live-course' | 'lecture-sheet';
...
export const PROJECT_STATUS: Select[] = [
...
export const TASK_STATUS: Select[] = [
...
export const Version: Select[] = [
  {value: 'হার্ডকভার', viewValue: 'হার্ডকভার'},
  {value: 'পেপারব্যাক', viewValue: 'পেপারব্যাক'},
  {value: 'স্পাইরাল', viewValue: 'স্পাইরাল'},
  {value: 'নিউজপ্রিন্ট', viewValue: 'নিউজপ্রিন্ট'},
  {value: 'পপআপ', viewValue: 'পপআপ'},
];
...
export const AMOUNT_EXCHANGE_TYPES: Select[] = [
  {value: 'Cash', viewValue: 'Cash'},
  {value: 'Bkash', viewValue: 'Bkash'},
  {value: 'Nagad', viewValue: 'Nagad'},
  {value: 'DBBL', viewValue: 'DBBL'},
  {value: 'Bank', viewValue: 'Bank'},
];

export const EXPENSE_CATEGORIES: Select[] = [
  {value: 'User', viewValue: 'User'},
  {value: 'Meal', viewValue: 'Meal'},
  {value: 'Company Asset', viewValue: 'Company Asset'},
  {value: 'Company Essential', viewValue: 'Company Essential'},
  {value: 'Others', viewValue: 'Others'},
];


export const defaultUploadImage = '/assets/images/avatar/image-upload.jpg';
export const defaultUploadPdf = '/assets/images/avatar/images.png';
export const VARIATION_IMG_PLACEHOLDER = '/assets/images/placeholder/image-pick-placeholder.png';
export const PDF_MAKE_LOGO = '/assets/images/png/test.png';

export const WEB_STATIC_DATA: CompanyInfo = {
  companyName: 'test',
  website: 'www.test.com',
  address: 'House: 3/4.Avenue, 5th Block-A, Mirpur-6, Dhaka-1216',
  email: 'test.info@gmail.com',
  phoneNo: '01773853656,01648879969',
  invoiceLogo: 'https://api.management.test.com/api/upload/images/test-invoice.png',
  sign: 'https://api.management.test.com/api/upload/images/sign.png',
  coFounderName: 'test',
  coFounderPhoneNo: '01000000000',
}

export const COMPANY_BANK_INFO: CompanyBankInfo = {
  name: 'test',
  accountName: 'test',
  accountNo: '1423185509001',
  routingNo: '225263585',
  branch: 'Pallabi Branch',
}

export const ADMISSION_PROJECTS: Select[] = [
  {value: 'Life Solutions BD', viewValue: 'Life Solutions BD'},
  {value: 'test', viewValue: 'test'},
];

export const ADMISSION_PAYMENT_TYPES: Select[] = [
  {value: 'New Admission Fee', viewValue: 'New Admission Fee'},
  {value: 'Due Amount', viewValue: 'Due Amount'},
];

export const SOCKET_GROUP: Select[] = [
...
export type OrderType = 'video-course' | 'live-course' | 'lecture-sheet';
