...
export class AdditionalPageService {
  ...
  updateAdditionalPageBySlug(slug: string, data: AdditionalPage) {
    return this.httpClient.put<{ message: string, success: boolean }>(API_PAGE + 'update/' + slug, data);
  }
  ...
  deleteAdditionalPageBySlug(slug: string, checkUsage?: boolean) {
    ...
    return this.httpClient.delete<ResponsePayload>(API_PAGE + 'delete/' + slug, {params});
  }
